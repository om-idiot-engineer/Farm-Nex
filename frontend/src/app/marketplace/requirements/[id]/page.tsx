...
import { getDemandPosts, type DataSource } from "@/lib/services/domain";
...
export default function RequirementDetailPage() {
  ...
  const loadRequirement = async () => {
    ...
    try {
      ...
      setDemand(result.data.find((item) => item.id === id) || null);
