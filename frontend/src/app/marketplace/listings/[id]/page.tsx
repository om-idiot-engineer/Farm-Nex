...
import { getMarketplaceListings, getUserReliabilityScore, type DataSource } from "@/lib/services/domain";
...
import type { ReliabilityScore } from "@/components/ReliabilityScoreCard";
...
export default function ListingDetailPage() {
  ...
  const loadListing = async () => {
    ...
    try {
      ...
      if (l) {
        const s = await getUserReliabilityScore(l.farmer_id);
        setScore(s);
      }
